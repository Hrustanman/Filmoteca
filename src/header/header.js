    ...
    return (
        <header>
            <nav className="navbar navbar-expand-lg navbar-light /*bg-light*/ fixed-top text-white">
                <a className='navbar-brand' href='#' ><h1 style={{ fontFamily: 'Snell Roundhand, cursive', color: '#3F7C9E', cursor:'pointer' }}>FilMotecA</h1></a>
                <button className="navbar-toggler" type="button" data-toggle="collapse"  data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                    <span className="navbar-toggler-icon"></span>
                </button>
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <Link to='/vv' className = 'link'>Увійти</Link>
                    <Link className='link'>Реєстрація</Link>
